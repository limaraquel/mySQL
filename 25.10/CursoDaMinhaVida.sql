...
insert into tb_categoria (nome,descricao, ativo) values ("Javascript","Curso inicial",true);
insert into tb_categoria (nome,descricao, ativo) values ("Java","Bootcamp", true);
insert into tb_categoria (nome,descricao, ativo) values ("Python","Curso avançado", true);
insert into tb_categoria (nome,descricao, ativo) values ("Ruby","Curso inicial", true);
insert into tb_categoria (nome,descricao, ativo) values ("C++","Curso Intermediário", true);
...
from tb_curso inner join tb_categoria on tb_categoria.id = tb_curso.categoria_id and tb_categoria.descricao = "Bootcamp";